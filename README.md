...
In the end we can compose all these to the end-to-end main consistency theorem [`model_exists`](https://github.com/leanprover/con-ron/blob/master/proof/ConRon/Capstone.lean#L616-L646) and main corollary [`no_False_declaration`](https://github.com/leanprover/con-ron/blob/master/proof/ConRon/Capstone.lean#L676-L707), matching what was proven about con-leche.
