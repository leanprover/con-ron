...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:244-246 viewApp` — `viewApp`, the
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:248-250 viewBVar` — `viewBVar`,
/// the `bvar` projection.
#[inline(always)]
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:252-254 viewSort` — `viewSort`,
/// the `sort` projection.
#[inline(always)]
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:256-258 viewConst` — `viewConst`,
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:260-263 viewConstName` —
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:265-267 viewFVarIdx` —
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:269-272 viewFVarTy` —
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:274-276 viewLit` — `viewLit`, the
/// `lit` projection.
#[inline(always)]
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:278-281 viewBind` — `viewBind`,
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:283-287 viewBindI` — `viewBindI`,
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:294-297 viewLet` — `viewLet`, the
/// `letE` projection.
#[inline(always)]
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:299-302 viewProj` — `viewProj`,
/// the `proj` projection.
#[inline(always)]
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:173-215 internE`.
///
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:311-312 internBVarE` — `internBVarE`,
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:311-314 internFVarE` — `internFVarE`,
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:311-316 internSortE` — `internSortE`,
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:311-318 internConstE` —
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:311-320 internAppE` — `internAppE`,
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:311-323 internLamE` —
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:335-365 internLamIE` —
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:367-384 internForallEIE` —
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:386-390 internBindIE` —
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:324-326 internForallEE` —
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:327-328 internLetEE` — `internLetEE`,
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:327-330 internLitE` — `internLitE`,
...
/// con-leche: none — hash-cons an expression node
/// Lean twin: `proof/ConRon/Arena/Monad.lean:327-333 internProjE` —
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:394-399 viewN` — decode a name
/// handle.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:401-417 internNNode` (the
...
/// con-leche: ConLeche/Kernel/Name.lean:34-37 Name
/// Lean twin: `proof/ConRon/Arena/Monad.lean:419-427 readName` — read a name
...
/// con-leche: ConLeche/Kernel/Name.lean:34-37 Name
/// Lean twin: `proof/ConRon/Arena/Monad.lean:429-438 readNames` — read a LIST
...
/// con-leche: ConLeche/Kernel/Name.lean:34-37 Name
/// Lean twin: `proof/ConRon/Arena/Monad.lean:429-438 readNames` — the cursor
...
/// con-leche: ConLeche/Kernel/Name.lean:34-37 Name
/// Lean twin: `proof/ConRon/Arena/Monad.lean:440-449 internName` — intern a
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:453-459 viewL` — decode a level
/// handle.
...
/// con-leche: ConLeche/Kernel/Expr.lean:41-54 Level
/// Lean twin: `proof/ConRon/Arena/Monad.lean:461-466 derivedL` — the level's
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:468-484 internLNode` (the
/// capacity test is one layer down here; see `intern_e`).
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:486-495 readLevel` — **the
...
/// con-leche: ConLeche/Kernel/Expr.lean:41-54 Level
/// Lean twin: `proof/ConRon/Arena/Monad.lean:497-514 internLevel` — intern a
...
/// con-leche: ConLeche/Kernel/Expr.lean:41-54 Level
/// Lean twin: `proof/ConRon/Arena/Monad.lean:518-524 viewLs` — the `none` arm
...
/// con-leche: ConLeche/Kernel/Expr.lean:41-54 Level
/// Lean twin: `proof/ConRon/Arena/Monad.lean:566-571 viewLsLen` — `viewLsLen`,
...
/// con-leche: ConLeche/Kernel/Expr.lean:344-354 Expr
/// Lean twin: `proof/ConRon/Arena/Monad.lean:518-524 viewLs` — decode a
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:526-542 internLsNode` (the
/// capacity test is one layer down here; see `intern_e`).
...
/// con-leche: ConLeche/Kernel/Level.lean:26-37 subst
/// Lean twin: `proof/ConRon/Arena/Monad.lean:544-550 readLevels` — read a
...
/// con-leche: ConLeche/Kernel/Level.lean:26-37 subst
/// Lean twin: `proof/ConRon/Arena/Monad.lean:589-602 readLevelM` —
...
/// con-leche: ConLeche/Kernel/Name.lean:34-37 Name
/// Lean twin: `proof/ConRon/Arena/Monad.lean:604-617 readNameM` — `readNameM`,
...
/// con-leche: ConLeche/Kernel/Name.lean:34-37 Name
/// Lean twin: `proof/ConRon/Arena/Monad.lean:619-627 readNamesM` —
...
/// con-leche: ConLeche/Kernel/Name.lean:34-37 Name
/// Lean twin: `proof/ConRon/Arena/Monad.lean:619-627 readNamesM` — the cursor
...
/// con-leche: ConLeche/Kernel/Level.lean:26-37 subst
/// Lean twin: `proof/ConRon/Arena/Monad.lean:629-642 readLevelsM` —
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:552-558 internLevelList`.
...
/// con-leche: none — intern a list of transient levels, one handle each
/// Lean twin: `proof/ConRon/Arena/Monad.lean:552-558 internLevelList` — the
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:560-564 internLevels`.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:654-671 internPersistentE`.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:673-687 internPersistentN`, through
/// the nesting.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:689-703 internPersistentL`, through
/// the nesting.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:705-719 internPersistentLs`, through
/// the nesting.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:728-731 inst1Get` — probe the
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:80-116 instantiate1Go
/// Lean twin: `proof/ConRon/Arena/Monad.lean:733-739 inst1Set` — record an
/// `instantiate1` answer.
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:182-184 instantiate1Fast
/// Lean twin: `proof/ConRon/Arena/Monad.lean:741-745 inst1Clear` — the memo is
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:747-750 instLGet` — probe the
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:267-303 instantiateListGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:752-758 instLSet` — record an
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:760-764 instLClear` — drop the
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:766-769 liftGet` — probe the
/// `liftLooseBVars` memo.
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:430-466 liftLooseBVarsGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:771-777 liftSet` — record a
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:779-783 liftClear` — drop the
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:785-788 resetGet` — probe the
/// `resetMeta` memo.
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:579-615 resetMetaGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:790-796 resetSet` — record a
/// `resetMeta` answer.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:798-802 resetClear` — drop the
/// `resetMeta` memo.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:804-807 renameGet` — probe the
/// `renameConsts` memo.
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:1001-1038 renameConstsGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:809-815 renameSet` — record a
/// `renameConsts` answer.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:817-821 renameClear` — drop the
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:823-826 abs1Get` — probe the
/// `abstract1` memo.
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:1791-1835 abstract1Go
/// Lean twin: `proof/ConRon/Arena/Monad.lean:828-834 abs1Set` — record an
/// `abstract1` answer.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:836-840 abs1Clear` — drop the
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:842-845 lowerGet` — probe the
/// `lowerBVars` memo.
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:2014-2051 lowerBVarsGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:847-853 lowerSet` — record a
/// `lowerBVars` answer.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:855-859 lowerClear` — drop the
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:861-864 inst1LGet` — probe the
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:2224-2263 instantiate1LiftGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:866-872 inst1LSet` — record an
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:874-878 inst1LClear` — drop the
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:880-883 instLPGet` — probe the
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:2566-2605 Expr.instLPGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:885-891 instLPSet` — record a
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:893-898 instLPClear` — drop the
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:2566-2605 Expr.instLPGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:900-903 instLPLGet` — probe the
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:2566-2605 Expr.instLPGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:905-911 instLPLSet` — record a
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:2566-2605 Expr.instLPGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:913-916 instLPLsGet` — probe the
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:2566-2605 Expr.instLPGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:918-924 instLPLsSet` — record a
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:926-929 bvarBGet` — probe the
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:1370-1394 bvarBoundGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:931-937 bvarBSet` — record a
/// loose-bvar bound.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:939-943 bvarBClear` — drop the
/// loose-bvar-bound memo.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:945-948 fvarBGet` — probe the
/// fvar-range memo.
...
/// con-leche: ConLeche/Kernel/ExprOps.lean:1399-1424 fvarRangeGo
/// Lean twin: `proof/ConRon/Arena/Monad.lean:950-956 fvarBSet` — record an
/// fvar range.
...
/// Lean twin: `proof/ConRon/Arena/Monad.lean:958-962 fvarBClear` — drop the
/// fvar-range memo.
