...
use arena_core::arena::handle::EIdx;
...
fn main() {
    ...
    println!(
        ...
        std::mem::size_of::<arena_core::arena::store::AppNode>(),
        std::mem::size_of::<EIdx>(),
        std::mem::size_of::<con_ron_core::ron::hashmap::AList<arena_core::arena::store::AppNode, EIdx>>()
    );
